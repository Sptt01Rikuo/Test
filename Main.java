...
class Task implements Runnable {
    ...
    public void run() {
        for (int i = 1; i <= 50; i++) {
            ...
            try {
                // หน่วงเวลาสุ่มระหว่าง 0 ถึง 400 มิลลิวินาที
...
- การเพิ่ม Thread.sleep() ทำให้เกิดการหน่วงเวลา ทำให้ลำดับการทำงานยิ่งไม่สามารถคาดเดาได้มากขึ้นเนื่องจากเธรดถูกหยุดชั่วคราวในระยะเวลาไม่แน่นอน
*/